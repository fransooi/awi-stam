	...
	async user_connect( connection, message )
	{
        ...
        var config =
        {
            ...
            [
				...
				{ name: 'connectors/project/project', config: { priority: 98 }, options: { templatesPath: this.templatesPath, runUrl: this.runUrl, projectsUrl: this.projectsUrl, templatesUrl: this.templatesUrl } },
				{ name: 'connectors/project/stos', config: { priority: 98 }, options: { templatesPath: this.templatesPath, runUrl: this.runUrl, projectsUrl: this.projectsUrl, templatesUrl: this.templatesUrl } },
				{ name: 'connectors/project/amos1_3', config: { priority: 98 }, options: { templatesPath: this.templatesPath, runUrl: this.runUrl, projectsUrl: this.projectsUrl, templatesUrl: this.templatesUrl } },
				{ name: 'connectors/project/amosPro', config: { priority: 98 }, options: { templatesPath: this.templatesPath, runUrl: this.runUrl, projectsUrl: this.projectsUrl, templatesUrl: this.templatesUrl } },
				{ name: 'connectors/project/javascript', config: { priority: 98 }, options: { templatesPath: this.templatesPath, runUrl: this.runUrl, projectsUrl: this.projectsUrl, templatesUrl: this.templatesUrl } },
				{ name: 'connectors/project/phaser', config: { priority: 98 }, options: { templatesPath: this.templatesPath, runUrl: this.runUrl, projectsUrl: this.projectsUrl, templatesUrl: this.templatesUrl } },
